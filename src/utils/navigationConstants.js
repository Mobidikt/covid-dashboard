export const NAV_TEXT = {
  casesGlobal: 'Global cases',
  casesGlobalPopulation: 'Global cases per 100 thousand population',
  caseLastDayPopulation: 'Cases in the last day per 100 thousand population',
  deathsGlobal: 'Global deaths',
  deathsGlobalPopulation: 'Global deaths per 100 thousand population',
  deathsLastDayPopulation: 'Deaths in the last day per 100 thousand population',
  recoveredGlobal: 'Global recovered',
  recoveredGlobalPopulation:
    'Global recovered people per 100 thousand population',
  recoveredLastDayPopulation:
    'Recovered in the last day per 100 thousand population',
  caseLastDay: 'Cases in the last day',
